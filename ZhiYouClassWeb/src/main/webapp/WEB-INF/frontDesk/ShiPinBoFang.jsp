	...
	<header>
		<div class="container">
			...
			<a onclick="JavaScript:addFavorite2()"><img
				src="./视频播放_files/sc.png" draggable="false">加入收藏</a> <a
				target="_blank"><img src="./视频播放_files/we.png" draggable="false">后台管理</a>
			<a class="color_e4"><img src="./视频播放_files/phone.png"
					...
					<div class="v-intro">
						<div class="left">
							<video id="videoPlayer"
								src="http://vod.zhiyou100.com/gkk/h5/c1/01.mp4"
						...
						<div class="right">
							...
							<div class="avatar">
								<span
									style="background-image: url(http://vod.zhiyou100.com/gkk/teacher/zgd.jpg
)"></span>
								<p>
									<b>讲师：赵桂丹</b><br>
									<i>H5第1期学员，毕业后留校任助教职务。精通H5课程内容，先后参与过智游教育网站、移动网站、微网站、课时管理系统等多个项目的开发工作。</i>
								</p>
							</div>
							<p class="video-intro">
			...
			<div class="catalog">
				<div class="container">
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">前端开发环境搭建</a>
						</p>
						...
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">433</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">562</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">HTML页面基本结构</a>
						</p>
						<p class="lecturer">前端开发主要技术和在项目中的作用、HTML标签基本结构、HTML文档基本结构、字符编码问题及开发一个简单的页面。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">365</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">596</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">新闻页面开发</a>
						</p>
						<p class="lecturer">
							新闻页面的开发，包括前端开发中最常用的HTML标签：H1、P、DIV、SPAN、IMG、A等，还包括控制文字、图片、超链接等最常用的CSS样式。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">332</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">1374</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">个人主页项目开发-1</a>
						</p>
						<p class="lecturer">个人主页项目的演示、页面结构分析、包括网页常见的构成：页头、LOGO、横幅、导航、主体、页脚等。在页头开发过程中使用了固定位置、定宽居中等常见的布局模式。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">284</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">1692</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">个人主页项目开发-2</a>
						</p>
						<p class="lecturer">个人主页项目页面主体部分的开发，大量使用了定宽居中的技术，在我的同学部分还使用了相对定位、绝对定位等非常重要定位技术，还使用了圆形边框等CSS3新技术。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">266</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">1699</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">个人主页项目开发-3</a>
						</p>
						<p class="lecturer">个人主页的语义化重构。介绍了H5语义化的意义、将非语义化的DIV+CSS改造成语义化标签的具体实践过程。以及VS
							Code分割视图在开发中的应用。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">236</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">409</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">个人简历项目开发-1</a>
						</p>
						<p class="lecturer">个人简历项目的开发。RGB颜色简介，字体简介及安装。本案例重度使用定位技术，使用了CSS3中新增的旋转图形变换技术。以及一些高级CSS选择器。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">232</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">2112</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">个人简历项目开发-2</a>
						</p>
						<p class="lecturer">个人简历项目开发的第二部分，包括字体的使用（注意：实际开发中会使用更高级的技术来使用字体）、背景图片的控制、内容溢出控制、绝对定位元素的层次控制、半透明的使用等。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">206</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">1997</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">场景秀项目开发-1</a>
						</p>
						<p class="lecturer">场景秀项目是一个手机页面、本部分介绍了响应式开发环境、viewport在响应式开发中的应用、vw/vh等响应式CSS单位的使用、CSS函数calc()在单位混合计算时的使用。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">218</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">1569</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">场景秀项目开发-2</a>
						</p>
						<p class="lecturer">场景秀动画部分的开发、本部分是场景秀开发的最出彩最重要的部分。包括关键帧动画的定义、平移动画、绽放动画等动画效果的实现方法。H5音频及JS控制音乐播放暂停。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">223</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">2179</span>
						</div>
					</div>
					...
					<div class="chapter">
						<p class="biaoti">
							<a
								href="http://localhost:8080/Voids/user/VideoGo.do?id=0&amp;subjectName=WEB%E5%89%8D%E7%AB%AF">响应式登录页面项目开发</a>
						</p>
						<p class="lecturer">响应式页面开发与移动端适配，重点内容包括vw/vh单位、媒体查询的介绍及在移动端适配中的应用方法。表单及INPUT标签的基本使用和使用CSS控制表单样式的方法等。</p>
						<p class="lecturer">讲师：赵桂丹</p>
						<div class="v-info">
							<span class="count"><img src="./视频播放_files/count.png"
								alt="">244</span> <span class="duration"><img
								src="./视频播放_files/player.png" alt="">2134</span>
						</div>
					</div>
